...
ADD `iconBgColor` VARCHAR(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `iconProductAvail`, 
ADD `iconTextColor` VARCHAR(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `iconBgColor`
;
