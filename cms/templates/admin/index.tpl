	...
	<header class="header">
		<div class="header_floating">
			...
			<div class="info_block">
				...
				<div class="pipe"></div>
				<div class="page_link"><a class="page_link_item" href="{$controller->baseURL}redirect/type:language/element:{$currentElement->id}/code:{$currentLanguage->iso6393}/" target="_blank">{translations name='header.open_in_public'}</a><span class="icon icon_page_link"></span></div>
			</div>
