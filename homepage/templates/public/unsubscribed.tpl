...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>{translations name='newsmails.unsubscribed'}</title>
	...
	<body>
		<div class="standalone_module">
			<div class="standalone_module_title"></div>
			<div class="standalone_module_content">{translations name='newsmails.unsubscribedmessage'}</div>
		</div>
	</body>
</html>