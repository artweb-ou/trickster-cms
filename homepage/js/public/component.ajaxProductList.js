window.AjaxProductsListComponent = function(productElement, productId, productsListSetsArray) {
    var self = this;
    /*
    ...
    */
    ...
    var getProductData = function(responseData) {
        new AjaxProductsListSingleItem(productId, responseData.product[0]);
...
window.AjaxProductsListSingleItem = function(productId, productItem) {
    // var productElement;
    var quickElement;
