<div class="invoice_header_block">
		...
		<tr>
			...
			<td class="invoice_header_invoice_info">
				<div class="invoice_header_order_title">
					<span class="invoice_header_order_number">{$data.orderNumber}</span>
				</div>
	...
	<table class="invoice_content_table">
		<tr>
			<td class="">
				<div class="">{translations name='labels.dear_payer'} {$data.payerFirstName} {$data.payerLastName},
				</div>
				<div class="">
					{translations name='invoice.emailsubject_order_status_notification'}<br>
					{translations name='labels.order_nr'} {$data.orderNumber}<br>
					{translations name='labels.order_status'}: {$data.payment.paymentStatus}<br>
					{*{translations name='invoice.emailsubject_order_status_notification'}.<br>*}
					{*{translations name='invoice.emailsubject_order_status_notification'}.<br>*}
				</div>
			</td>
