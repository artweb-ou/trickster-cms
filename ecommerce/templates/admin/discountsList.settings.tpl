...
<form action="{$element->getFormActionURL()}" class="form_component productcatalogue_form" method="post" enctype="multipart/form-data">
	<table class="form_table">
		...
		<tr>
			...
			<td>
				<select class="dropdown_placeholder" name="{$formNames.manualSortingEnabled}">
					...
					<option value='0' {if $formData.manualSortingEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
		...
		<tr>
			...
			<td>
				<select class="dropdown_placeholder" name="{$formNames.priceSortingEnabled}">
					...
					<option value='0' {if $formData.priceSortingEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
		...
		<tr>
			...
			<td>
				<select class="dropdown_placeholder" name="{$formNames.nameSortingEnabled}">
					...
					<option value='0' {if $formData.nameSortingEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
		...
		<tr>
			...
			<td>
				<select class="dropdown_placeholder" name="{$formNames.dateSortingEnabled}">
					...
					<option value='0' {if $formData.dateSortingEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
		...
		<tr>
			<td class="form_label">
				{translations name='category.brandSortingEnabled'}:
			</td>
			<td>
				<select class="dropdown_placeholder" name="{$formNames.brandSortingEnabled}">
					<option value='1' {if $formData.brandSortingEnabled=='1'}selected='selected'{/if}>{translations name='category.enabled'}</option>
					<option value='0' {if $formData.brandSortingEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
				{include file=$theme->template('component.form_help.tpl') structureType=$element->structureType name="brandSortingEnabled"}
			</td>
		</tr>
		<tr>
			<td class="form_label">
			...
			<td>
				<select class="dropdown_placeholder" name="{$formNames.brandFilterEnabled}">
					...
					<option value='0' {if $formData.brandFilterEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
		...
		<tr>
			...
			<td>
				...
				<select class="dropdown_placeholder" name="{$formNames.parameterFilterEnabled}">
					...
					<option value='0' {if $formData.parameterFilterEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
		...
		<tr>
			...
			<td>
				<select class="dropdown_placeholder" name="{$formNames.availabilityFilterEnabled}">
					...
					<option value='0' {if $formData.availabilityFilterEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
		...
		<tr>
			...
			<td>
				<select class="dropdown_placeholder" name="{$formNames.amountOnPageEnabled}">
					...
					<option value='0' {if $formData.amountOnPageEnabled=='0'}selected='selected'{/if}>{translations name='category.disabled'}</option>
				</select>
