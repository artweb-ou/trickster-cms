window.ShoppingBasketSelectionComponent = function(componentElement) {
	...
	var init = function() {
		...
		totalsContainerElement = componentElement.querySelector('.shoppingbasket_total_value');
		productPriceElements = componentElement.querySelectorAll('.shoppingbasket_total_products');
	...
	var updateData = function() {
		...
		if (totalsContainerElement) {
			totalsContainerElement.innerHTML = totalPrice + ' ' + window.selectedCurrencyItem.symbol;
		}
